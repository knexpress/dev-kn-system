...
async function checkDecemberReports() {
  try {
    ...
    console.log(`🔍 Searching for reports between ${dec4Start.toISOString()} and ${dec6Start.toISOString()}\n`);
    ...
    console.log(`📊 Found ${reports.length} reports from December 4-5, 2025\n`);

    if (reports.length > 0) {
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('📋 DECEMBER 4-5, 2025 REPORTS');
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
      ...
      console.log('⚠️  No reports found for December 4-5, 2025\n');
      
      // Check what dates we do have around that time
      console.log('🔍 Checking reports around that time period...\n');
      ...
      console.log(`📊 Found ${nearbyReports.length} reports from December 3-6, 2025:\n`);
    ...
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('🔍 Checking by ObjectId timestamp...');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log(`📊 Reports found by ObjectId timestamp (Dec 4-5): ${reportsByObjId.length}\n`);
